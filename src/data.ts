...
export const workData = [
  {
    ...
    company: "MI Conseils",
    responsabilites: [
      "Backend developement using PHP, Laravel, Express, TypeScript",
      "Database and API design",
      "Deployoment, Docker and CI/CD",
      "Some Frontend developement using React and Next",
    ],
  },
  {
    logo: upwork,
...
export const feedbacks = [
  {
    feedback:
      "Wassim  is an outstanding collaborator, with whom I have had the opportunity to work on multiple projects that were all executed seamlessly. Additionally, his expertise and professionalism have greatly contributed to our success.",
    name: "Younes Ferradji",
    post: "Full Stack Developer @KBnet, Web Developement Instructor",
  },
  {
    feedback:
      "Wassim is a talented and dedicated developer. He has a strong work ethic and is always willing to go the extra mile to ensure that projects are completed on time and to the highest standards.",
    name: "Mohammed Ichou",
    post: "Full Stack Developer @MI Conseils",
  },
  {
    feedback:
      "Wassim was a great partner in hackathons and projects. He is a great team player and has a positive attitude that makes him a pleasure to work with.",
    name: "Zakaria Reguig",
    post: "Partner in multiple hackathons",
  },
];
